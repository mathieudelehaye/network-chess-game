...
public:
    json handleJoinRequest(GameContext* context, const std::string& player_id, const std::string& color) override;
    ...
    json handleMoveRequest(GameContext* context, const std::string& player_id, const std::string& from, const std::string& to) override {
